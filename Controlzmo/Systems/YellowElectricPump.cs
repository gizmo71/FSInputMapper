...
namespace Controlzmo.Systems
{
    ...
    {
        [SimVar("L:A32NX_OVHD_HYD_EPUMPY_PB_IS_AUTO", "bool", SIMCONNECT_DATATYPE.INT32, 0.5f)]
        public Int32 isAutoA32nx;
        [SimVar("L:A32NX_OVHD_HYD_EPUMPY_PB_HAS_FAULT", "bool", SIMCONNECT_DATATYPE.INT32, 0.5f)]
        public Int32 isFaultA32nx;
    ...
    public partial class YellowElectricPumpButton : DataListener<YellowElectricPumpData>, IRequestDataOnOpen, ISettable<bool>
    {
        ...
        public override void Process(ExtendedSimConnect simConnect, YellowElectricPumpData data) {
            ...
            else if (simConnect.IsA32NX) { isOn = data.isAutoA32nx == 0; isFault = data.isFaultA32nx != 0;}
            string colour = "";
        ...
        public void SetInSim(ExtendedSimConnect simConnect, bool isPressed) {
            ...
            else if (simConnect.IsA32NX && isPressed)
                sender.Execute(simConnect, "(L:A32NX_OVHD_HYD_EPUMPY_PB_IS_AUTO, Bool) ! (>L:A32NX_OVHD_HYD_EPUMPY_PB_IS_AUTO)");
        }
    }
}
